  ...
  ##      self.canvas.mainWindow().addDockWidget(Qt.LeftDockWidgetArea, self)
   ...
   ##         self._onManageServersRequested()
    ...
    def opendatasets(self): 
        ...
        self.postInformationMessageToUser("Open Datasets...")
    ...
    def openvariables(self): 
        ...
        self.postInformationMessageToUser("Open Variables...")
    ...
    def opentimeanddepth(self) :
        ...
        self.postInformationMessageToUser("Populate with and depth ...")
    ...
    def _onbuttonReqMapPlotClicked(self):
        ...
        self.postInformationMessageToUser("Request WMS map with matplotlib ...")
    ...
    def _onbuttonMotuRequest(self): 
        ...
        self.postInformationMessageToUser("Motu resquest ...")
        ...
        if self.tabWidget.currentIndex() == self.tabWidget.indexOf(self.tab_WCS):
            ...
            try:
                ...
                if None is not layerSelectedObject or len(layerSelectedObject) > 0:
                    ...
                    ##                            rastermax,nb_colors,style)
                    self.logger.info("Get Async WMS")
                    ...
                    self.controller.asyncFetchWMSImageFile(self.currentMap,
                                                            ...
                                                            boundingBox = boundingBoxToDownload)
                    self.logger.info("Get Async WMS OK")
            except Exception as exc:
                print(exc)
