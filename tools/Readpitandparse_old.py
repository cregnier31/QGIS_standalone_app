...
import cPickle
global str
filecsv='/home/cregnier/Data_test/pit.csv'
filecsv='/home/cregnier/pit.csv'
...
with open(filecsv, 'r') as csvfile:
    ...
    for row in pitreader:
        if i !=0 : 
           ...
           ind_endtime=description_var.index(time_end)
           ind_server=description_var.index(server_name)
...
#filetype="/home/cregnier/DEV/Python/csv/cmems_dic_pit.p"
filetype="/home/cregnier/SVN/mo/TEP/SIG/branches/Charly_V0/statics/cmems_dic_tot_pit.p"
